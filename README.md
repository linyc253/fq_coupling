...
where readout and xy are optional. Other floating islands can be named as `{whatevername}_B{number}`. All readout resonator frequencies are assumed to be 6.0 GHz.
